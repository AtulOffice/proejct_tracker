...
const WeeklyTableAll = ({ data }) => {
  ...
  return (
    <div className="relative h-full col-span-full w-full italic overflow-hidden rounded-2xl shadow-2xl bg-linear-to-b from-white via-blue-50 to-blue-100 border border-blue-200">
      ...
      <div className="overflow-x-auto">
        <div className="max-h-[690px] overflow-y-auto">
          <table className="w-full table-fixed">
            <thead>
              <tr className="bg-linear-to-r from-purple-600 via-pink-500 to-pink-600 text-white shadow-lg">
              ...
              {data.map((item, indx) => (
                ...
                >
                  <td className="px-6 py-4">
                    <div
                      className="text-[12px] text-blue-900 wrap-break-words max-w-xs"
                  ...
                  <td className="px-6 py-4 text-base text-blue-800 whitespace-nowrap text-right">
                    <div
                      ...
                      className="inline-block bg-linear-to-r from-blue-100 via-indigo-100 to-blue-200
      ...
      <div className="bg-linear-to-r from-blue-50 to-indigo-50/70 px-6 py-5 border-t border-blue-100">
