      ...
      >
        ...
        <div className="flex flex-row justify-center items-center space-x-2 sm:space-x-4 pb-6">
          <button
            ...
            className="px-6 sm:px-8 py-2 rounded-lg text-white font-semibold shadow transition bg-gradient-to-r from-blue-600 via-indigo-500 to-sky-700 hover:bg-blue-700/90 hover:shadow-lg"
          >
            Refresh
          </button>
          <button
        ...
        <div className="relative w-full overflow-x-auto rounded-2xl shadow-xl border border-indigo-400 bg-gradient-to-b from-white/80 via-blue-50 to-blue-100">
          <div ref={printRef}>
            <table className="w-full table-fixed text-sm sm:text-base">
              <thead>
                <tr className="bg-gradient-to-r from-blue-800 via-indigo-700 to-blue-600 text-white shadow-lg text-xs sm:text-sm">
              ...
              <tbody>
                {notifications.map((note, i) => (
                  ...
                  >
                    ...
                    <td
                      className={`px-4 sm:px-6 py-3 font-bold truncate ${
                        note.priority === "High"
                          ? "text-red-600"
                    ...
                    <td className="px-4 sm:px-6 py-3 text-gray-700 text-sm break-words">
          ...
          {/* Footer */}
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50/70 px-4 sm:px-6 py-3 border-t border-indigo-200">
