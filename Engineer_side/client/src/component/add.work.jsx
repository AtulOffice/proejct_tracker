...
const EngineerWorkStatus = ({ project, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-5xl bg-linear-to-br from-slate-50 to-slate-100 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
        <div className="bg-linear-to-r from-purple-600 via-pink-600 to-rose-600 px-8 py-6 relative">
          <button
            onClick={onClose}
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center pt-4">
              <button
                ...
                className="px-12 py-3.5 bg-linear-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-[1.02]"
              >
                Submit Work Status
              </button>
            </div>
