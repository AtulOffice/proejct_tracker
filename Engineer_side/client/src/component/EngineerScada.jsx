...
// export default function ScadaDevelopmentExecution({ onClose,project }) {
...
//                             <div>
//                                 <h2 className="text-2xl font-black text-gray-900 tracking-tight bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
//                                     17. SCADA DEVELOPMENT EXECUTION
//                                 </h2>
//                                 <p className="mt-2 text-sm text-gray-600">
//                                     Track and manage SCADA development sections with progress monitoring.
//                                 </p>
//                             </div>

//                             <span className="flex-shrink-0 rounded-2xl border-2 border-indigo-300 bg-gradient-to-r from-indigo-50 to-indigo-100 px-5 py-2 text-xs font-bold uppercase tracking-wider text-indigo-700 shadow-lg">
//                                 SCADA Panel
//                             </span>
//                         </div>
...
//                                     Section Name
//                                 </label>
//                                 <input className="w-full rounded-xl border-2 border-rose-300 bg-rose-50 px-4 py-2.5 text-sm text-rose-900 placeholder:text-rose-400 focus:border-rose-400 focus:ring-4 focus:ring-rose-100 transition-all" />
//                             </div>
...
//                                 <input
//                                     disabled
//                                     className="w-full rounded-xl border-2 border-amber-300 bg-amber-50 px-4 py-2.5 text-sm font-semibold text-amber-900 shadow-sm"
//                                 />
//                             </div>
...
//                                     Actual Completion %
//                                 </label>
//                                 <input className="w-full rounded-xl border-2 border-amber-300 bg-amber-50 px-4 py-2.5 text-sm font-bold text-amber-900 placeholder:text-amber-500 focus:border-amber-400 focus:ring-4 focus:ring-amber-100 transition-all" />
//                             </div>
//                         </div>
...
//                                 placeholder="Add important notes, risks or dependencies..."
//                             />
//                         </div>
...
//                             <button
//                                 type="button"
//                                 className="group relative px-8 py-4 text-white font-black text-sm uppercase tracking-wider rounded-2xl bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 shadow-2xl hover:shadow-blue-500/50 hover:scale-105 active:scale-95 transition-all duration-300 overflow-hidden"
//                             >
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            <div>
                                ...
                                <input
                                    className="w-full rounded-xl border-2 border-rose-300 bg-rose-50 px-4 py-3 text-sm text-rose-900 placeholder:text-rose-400 focus:border-rose-400 focus:ring-4 focus:ring-rose-100 transition-all"
                                    placeholder="e.g. Main Control Screen"
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            <div>
                                ...
                                <input
                                    disabled
                                    className="w-full rounded-xl border-2 border-amber-300 bg-amber-50 px-4 py-3 text-sm font-semibold text-amber-900 shadow-sm"
                        ...
                        <div className="flex justify-center pt-6 border-t-2 border-gray-200">
                            <button
                                type="button"
                                className="group relative px-10 py-5 text-white font-black text-base uppercase tracking-wider rounded-2xl bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 shadow-2xl hover:shadow-blue-500/50 hover:scale-105 active:scale-95 transition-all duration-300 overflow-hidden"
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
