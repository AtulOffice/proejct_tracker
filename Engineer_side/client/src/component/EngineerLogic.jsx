...
// export default function LogicDevelopmentExecution({ onClose, project }) {
...
//                 </label>
//                 <input
//                   className="w-full rounded-xl border-2 border-gray-300 bg-gray-50 px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 transition-all"
...
//               </label>
//               <input
//                 className="w-3/4 rounded-xl border-2 border-gray-300 bg-gray-50 px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 transition-all"
